...
export const ORGS: Org[] = [
  { id: "navigrains", name: "Navigrains", type: "charterer", country: "Greece", tier: "Tier 3", address: "1 Charilaou Trikoupi Street, 185 36, Piraeus, Greece", desk: { name: "Chartering Desk", email: "chartering@navigrains.com", phone: "+30 210 452 7788" }, members: [{ name: "Karim Saleh", role: "broker", current: true }, { name: "Eleni Pappas", role: "admin" }, { name: "Omar Farouk", role: "broker" }] },
  { id: "satirbroke", name: "Satirbroke", type: "broker", country: "Turkey", tier: "Tier 2", address: "Kemankeş Karamustafa Paşa, Rıhtım Cd. 28, 34425 Beyoğlu, İstanbul", desk: { name: "Dry Cargo Desk", email: "drycargo@satirbroke.com", phone: "+90 212 243 1190" }, members: [{ name: "Deniz Aktaş", role: "admin" }, { name: "Mert Yılmaz", role: "broker" }] },
  { id: "medshipping", name: "Mediterranean Shipping Services", type: "charterer", country: "Egypt", tier: "Tier 3", address: "20 Mahmoud Hamdy Street, Alexandria 21514, Egypt", desk: { name: "Operations Desk", email: "ops@medshipservices.com", phone: "+20 3 487 6620" }, members: [{ name: "Yasmine Adel", role: "admin" }, { name: "Hany Mansour", role: "broker" }] },
  { id: "gulfsea", name: "Gulf Sea Brokers", type: "broker", country: "UAE", tier: "Tier 4", address: "Unit 801, Bays Tower, Business Bay, Dubai, UAE", desk: { name: "Chartering Desk", email: "desk@gulfseabrokers.ae", phone: "+971 4 551 2030" }, members: [{ name: "Rashid Al-Marri", role: "admin" }, { name: "Sana Qureshi", role: "broker" }] },
  { id: "orientseas", name: "Orient Seas Ltd Co", type: "owner", country: "Saudi Arabia", tier: "Tier 2", imo: "6285232", fleetTotal: 5, address: "6th Floor, Al Falih Building, 2491 Taweriq, Al-Saddad District, Jeddah, Saudi Arabia", desk: { name: "Commercial Desk", email: "chartering@orientseas.com.sa", phone: "+966 12 690 4411" }, members: [{ name: "Faisal Al-Harbi", role: "admin" }, { name: "Tariq Nasser", role: "broker" }] },
  { id: "thalatta", name: "Thalatta Shipping Management", type: "manager", country: "Greece", tier: "Tier 2", imo: "0067951", fleetTotal: 5, address: "Akti Miaouli 33, 185 35 Piraeus, Greece", desk: { name: "Operations Desk", email: "ops@thalatta-mgmt.gr", phone: "+30 210 429 5500" }, members: [{ name: "Nikos Andreou", role: "admin" }] },
  { id: "suezship", name: "Suez Ship Management", type: "manager", country: "Egypt", tier: "Tier 1", fleetTotal: 4, address: "Shop 1, 359, 23rd July Street, Suez 35923, Egypt", desk: { name: "Operations", email: "ops@suezship.com", phone: "+20 62 319 0042" }, members: [{ name: "Ahmed Sabry", role: "admin" }] },
  { id: "abkshipping", name: "ABK Shipping Co", type: "owner", country: "Lebanon", tier: "Tier 1", imo: "5901913", fleetTotal: 1, address: "C/O Cedar Marine Services SAL, Tripoli, Lebanon", desk: { name: "Owner's Desk", email: "chartering@abkshipping.com", phone: "+961 6 433 210" }, members: [{ name: "Bilal Khoury", role: "admin" }] },
  { id: "denizid", name: "Deniz ID Maritime Ltd", type: "owner", country: "Turkey", tier: "Tier 1", fleetTotal: 1, address: "C/O Overseas Marine Ltd, Mezitli, Mersin, Turkey", desk: { name: "Owner's Desk", email: "ops@denizid.com.tr", phone: "+90 324 357 1188" }, members: [{ name: "Can Demir", role: "admin" }] },
];
