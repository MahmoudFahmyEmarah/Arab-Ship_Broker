...
| 16 | `…000920_market_insights_subscribers` | **Weekly email capture** — `market_insights_subscribers` + anon `fn_market_insights_subscribe(email)`. | `SELECT public.fn_market_insights_subscribe('x@y.com');` → `{ok:true}`. |
