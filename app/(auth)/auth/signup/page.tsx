    ...
    >
      <div
        className={`
          ...
          ${selected ? "bg-ocean-500 text-white" : "bg-slate-200 text-slate-500"}
        `}
      >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between">
          <span
            className={`font-semibold text-sm ${selected ? "text-ocean-700" : "text-slate-700"}`}
          >
            {label}
          </span>
          {selected ? (
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <div className="relative group">
                            <User className="absolute left-3.5 top-1/2 transform -translate-y-1/2 text-slate-400 w-4 h-4 group-focus-within:text-ocean-500 transition-colors" />
                            <Input
                              {...field}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <div className="relative group">
                            <Mail className="absolute left-3.5 top-1/2 transform -translate-y-1/2 text-slate-400 w-4 h-4 group-focus-within:text-ocean-500 transition-colors" />
                            <Input
                              {...field}
                              type="email"
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <div className="relative group">
                              <Lock className="absolute left-3.5 top-1/2 transform -translate-y-1/2 text-slate-400 w-4 h-4 group-focus-within:text-ocean-500 transition-colors" />
                              <Input
                                {...field}
