...
const stats = [
  { value: "167", label: "Cargo Records", suffix: "+" },
  { value: "62", label: "Vessels Tracked", suffix: "" },
  { value: "14", label: "Trade Zones", suffix: "" },
  { value: "2", label: "Hour Review SLA", suffix: "hr" },
];
    ...
    <div className="flex flex-col w-full overflow-hidden bg-slate-50">
      ...
      <section className="relative z-20 -mt-20 max-lg:-mt-16 max-sm:-mt-12">
        <div className="container">
          ...
          >
            <div className="grid grid-cols-4 max-lg:grid-cols-2 gap-10 max-lg:gap-8 max-sm:gap-6">
              {stats.map((stat) => (
