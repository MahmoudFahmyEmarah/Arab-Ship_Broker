...
export default function NotFound() {
  return (
    <main className="relative isolate flex min-h-[70svh] items-center justify-center overflow-hidden px-6 py-20 max-[768px]:py-14">
      ...
      <section className="relative w-full max-w-2xl rounded border border-asb-gray-200/80 bg-white/90 p-12 max-[768px]:p-8 shadow-xl shadow-slate-900/5 backdrop-blur-sm">
        <p className="text-sm font-semibold uppercase tracking-[0.2em] text-asb-blue">
          Page not found
        </p>

        <h1 className="mt-3 text-7xl max-[768px]:text-6xl font-bold tracking-tight text-asb-navy">
          404
        </h1>

        <p className="mt-5 max-w-xl text-lg max-[768px]:text-base leading-relaxed text-asb-gray-700">
