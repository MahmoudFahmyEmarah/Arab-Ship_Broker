        ...
        {tab === "definition" && (
          <>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(2,minmax(0,1fr))", gap: 10 }}>
              ...
              <div className="adm-field"><label className="adm-field__label">Severity</label><Seg options={[{ id: "error", label: "error", tip: "Blocks the market" }, { id: "warn", label: "warn", tip: "Visible but allowed" }, { id: "info", label: "info", tip: "Advisory only" }]} value={d.severity} disabled={!canEdit} onChange={(v) => upd({ severity: v })} /></div>
