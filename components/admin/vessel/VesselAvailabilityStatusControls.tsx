...
const STATUS_COLORS: Record<StatusType, { active: string; inactive: string }> =
  {
    OPEN: {
      ...
      inactive: "border-asb-gray-200 text-asb-gray-700 hover:border-green-400",
    },
    "ON SUBS": {
      active: "bg-amber-500 text-white border-amber-500",
      inactive: "border-asb-gray-200 text-asb-gray-700 hover:border-amber-400",
    },
    FIXED: {
      active: "bg-asb-gray-700 text-white border-asb-gray-400",
      inactive: "border-asb-gray-200 text-asb-gray-700 hover:border-asb-gray-400",
    },
    INACTIVE: {
      active: "bg-red-600 text-white border-red-600",
      inactive: "border-asb-gray-200 text-asb-gray-700 hover:border-red-400",
    },
  };
    ...
    <div className="space-y-4">
      <div className="dp-card overflow-hidden">
        ...
        <div className="px-5 pb-4">
          <p className="text-[10px] text-asb-gray-400">
